...
public class Boid {
	...
	/*
	 * if our next step on our current heading is outside of the canvas, add
	 * the weighted heading back towards the center of the canvas
	 */
	if (nextLocation.getX() < 0 || nextLocation.getX() > canvas.getWidth()
		|| nextLocation.getY() < 0
